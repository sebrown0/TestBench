...
INSERT INTO `dakartest`.`application`
	(`name`,`description`)
VALUES
	("TestSystem","A test system for the Dakar Test Bench.");
    
INSERT INTO `dakartest`.`version`
	(`major`,`minor`,`build`,`notes`,`application_id`)
VALUES
	(1,0,1,"First build of the Test System.", 1),
    (1,0,2,"Second build of the Test System.", 1);
...
VALUES
	("SB1",1,1,"Test run 1 for Test System","No notes");
